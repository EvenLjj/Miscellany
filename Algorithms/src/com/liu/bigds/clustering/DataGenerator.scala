...
/**
 *
 * 参数:1.address of spark master 2.path of data storage at HDFS 3. number of points 4. length of features 5.table name at HDFS 6.number of clusters 7.value of variance
 */
...
object DataGenerator {
  ...
  def run(args: Array[String]): Unit = {
    ...
    val conf = new SparkConf()
      .setMaster(args(0))
      .setAppName("Spectral Clustering Synthetic Data Generator")
